...
export const DeleteItem = (deleteItemProp: DeleteItemProp) => {
 const {deleteTitle, deleteMessage, deleteItem, cancelButton, submitButton} = deleteItemProp;

 let tabIndex = -1 

 return (
  
   <div className="modal fade show d-block mt-5 mt-5" id="exampleModal" role="dialog" tabIndex={tabIndex}>
